...
HEATMAP_COLOR_NEGATIVE = (198, 88, 45)
HEATMAP_COLOR_MID = (232, 196, 102)
HEATMAP_COLOR_POSITIVE = (82, 158, 79)
HEATMAP_SURFACE_ALPHA = 210
HEATMAP_SURFACE_SIDE_WALL_NEUTRAL = (224, 219, 208)
HEATMAP_SURFACE_SIDE_WALL_TINT_RATIO = 0.18
HEATMAP_SURFACE_SIDE_WALL_ALPHA = 174
HEATMAP_SURFACE_TOP_CAP_LIFT_M = 900.0
HEATMAP_SURFACE_ZERO_PLANE_ELEVATION_M = 520_000.0
HEATMAP_SURFACE_CELL_SIZE_DEGREES = 0.65
HEATMAP_SURFACE_COLOR_QUANTILE = 0.88
HEATMAP_SURFACE_ELEVATION_QUANTILE = 0.5
HEATMAP_SURFACE_MAX_ELEVATION_M = 470_000.0
HEATMAP_SURFACE_ELEVATION_FLOOR_RATIO = 0.035
HEATMAP_SURFACE_ELEVATION_GAMMA = 0.34
HEATMAP_SURFACE_ELEVATION_BOOST = 1.7
