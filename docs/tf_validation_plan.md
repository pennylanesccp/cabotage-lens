...
The plan should be read together with `docs/tf_assumptions_and_approximations.md`. The planning files `docs/tf_document_structure.md`, `docs/tf_system_boundary.md`, and `docs/tf_data_reliability_inventory.md` were not present in the repository when this plan was prepared.
