...
As limitações apresentadas no Capítulo~\ref{ch:limitacoes}, portanto, não enfraquecem a conclusão; elas definem seu uso correto. O TF pode concluir que o \CabotageLens{} produz comparações rastreáveis, auditáveis e academicamente defensáveis sob fronteiras explícitas. Não pode concluir que a cabotagem seja universalmente superior, que custos modelados sejam fretes comerciais, que emissões operacionais \ttw{} de \cooe{} sejam \wtw{}/LCA, que sensibilidades sejam resultados robustos de baseline ou que Gustavo/Costa tenha sido plenamente reproduzido.
...
Validação e benchmark & Reconciliar carga, TEU, fator de carga, alocação, distância, rota, porto, serviço, operações portuárias e fronteira ambiental. & Gustavo/Costa pode continuar como benchmark, mas não deve ocupar o centro da contribuição.\\
