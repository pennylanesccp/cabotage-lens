...
Sob essa formulação, os resultados do \CabotageLens{} devem ser lidos como estimativas de cenário sob as fronteiras metodológicas definidas. A seleção de portos, a distância marítima, os acessos terrestres, os componentes portuários, os parâmetros de carga, a fronteira econômica, a fronteira ambiental e a classificação de validação condicionam o alcance de cada conclusão.
