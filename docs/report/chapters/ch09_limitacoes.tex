...
O Capítulo~\ref{ch:limitacoes} deve ser lido como controle de sobreafirmação. Ele separa o que o protótipo sustenta, o que permanece condicionado e o que ainda exige evidência externa. A interpretação segura dos resultados atuais é cenário-dependente, direcional e diagnóstica: sensibilidades mostram comportamento do modelo sob hipóteses rastreadas; o benchmark do Prof. Dr. Gustavo Costa apoia consistência direcional, mas não valida magnitude calibrada; e diagnósticos explicam lacunas sem substituir a linha de base.
...
Por fim, os resultados do TF não devem ser generalizados para todos os corredores brasileiros. As conclusões são específicas por rota, cenário, carga, porto, distância, proveniência, fronteira econômica, fronteira ambiental e classificação de evidência. O trabalho pode concluir que o \CabotageLens{} oferece uma estrutura auditável e academicamente útil para comparação de cenários; não pode concluir que a cabotagem seja universalmente superior, que custos modelados sejam fretes comerciais, que o benchmark do Prof. Dr. Gustavo Costa seja verdade de referência, ou que sensibilidades e literatura resolvam todas as lacunas de rota, validação, custo, emissões e operação.
