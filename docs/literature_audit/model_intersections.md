...
*(Note: Alignments are provisional, pending manual extraction of evidence from the blocked PDF sources).*
...
* **Alignment**: High (Theoretical, evidence pending).
...
* **Alignment**: Partial (Theoretical, evidence pending).
...
* **Alignment**: Moderate (Theoretical, evidence pending).
...
* **What literature says**: Accurate maritime distance is essential for correct emissions estimates (`competitiveness2024`).
...
## 8. CO2 versus CO2e
* **What literature says**: They must not be mixed; CO2e includes methane and other GHGs (`decarb2024`).
* **What CabotageLens does**: Tracks emissions.
* **Alignment**: Needs verification (Theoretical, evidence pending).
...
* **What literature says**: Hoteling and port equipment contribute materially to the total footprint (`berth2009`, `shipops2022`).
