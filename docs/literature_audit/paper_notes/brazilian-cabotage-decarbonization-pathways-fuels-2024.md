...
* **Useful quantitative values, with units**: 
  - Average ship consumption at sea: 3.5 tons/day
  - Average ship consumption at port (hoteling): 5.0 tons/day
  - HVO WTW emission factor: 23.7 gCO2e/MJ
  - MDO WTW emission factor: 93.8 gCO2e/MJ
  - Transitioning to HVO could reduce emissions by 75.4% (from 1,395,466 to 343,950 tons CO2e/year).
* **Emissions boundary**: WTW / CO2e. Explicitly calculates the WTW (Well-to-Wake) lifecycle.
* **Cost boundary**: N/A
* **Route/network modeling boundary**: Assumes distances based on Pilot Stations. Assumes a standard navigation duration of 2 hours at 10 knots for entry/exit at ports.
* **Direct implications for CabotageLens methodology**: Provides excellent real-world averages for hoteling and steaming consumption (3.5 tons/day vs 5.0 tons/day) from a Brazilian shipping company.
* **Direct implications for validation Batch 001 / Batch 001B**: Helpful for tuning the hoteling model.
