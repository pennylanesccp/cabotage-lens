...
Para saber se a cabotagem faz sentido em uma ligação específica, a comparação precisa ser porta a porta. Na alternativa rodoviária, a carga segue diretamente por estrada. Na alternativa multimodal, porém, sua rota é bem mais complexa: ela percorre um acesso rodoviário até o porto, uma perna marítima e outro acesso rodoviário até o destino final. Portos, distâncias, carga transportada e interfaces operacionais podem mudar o resultado [shortsea2019; modalshiftreview2020].
