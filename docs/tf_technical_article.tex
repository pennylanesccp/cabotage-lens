...
\end{minipage} & \begin{minipage}[t]{0.22\columnwidth}\raggedleft
3.041,62~kg~CO₂e\strut
\end{minipage} & \begin{minipage}[t]{0.22\columnwidth}\raggedright
1.026,66~kg~CO₂e a menos (25,24\%).\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.22\columnwidth}\raggedright
Custo modelado do combustível\strut
\end{minipage} & \begin{minipage}[t]{0.22\columnwidth}\raggedleft
...
* No recorte atual da Agência Nacional de Transportes Aquaviários
(ANTAQ), não há uma viagem observada entre Santos e Vila do Conde. A
distância marítima usada nesta comparação é de 4.495 km, ou 2.427 milhas
náuticas, conforme os dados publicados pelo
\href{https://www.geografos.com.br/}{Geógrafos}. A intensidade de 6,07
g/(t·nm) continua vindo da classe de navio \texttt{container\_feeder}.
...
adotada para cada porto. O CabotageLens registra que a distância marítima
é externa e não a apresenta como uma viagem observada.
...
rodoviária direta. Mesmo assim, emite 25,24\% menos CO₂e operacional e
