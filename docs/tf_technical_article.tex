...
\begin{tikzpicture}
  ...
  \node[align=center, text width=4.30cm, font=\scriptsize] at (2.55cm,1.45cm) {Distância: 1.259,179 nm\\Carga a bordo: 12.858,754 t};
  \node[align=center, text width=4.30cm, font=\scriptsize] at (7.65cm,1.45cm) {Distância: 507,806 nm\\Carga a bordo: 16.718,333 t};
  \node[align=center, text width=4.30cm, font=\scriptsize] at (12.75cm,1.45cm) {Distância: 1.185,594 nm\\Carga a bordo: 12.325,900 t};
  \draw[clarrow] (mS) -- (mU);
  \draw[clarrow] (mU) -- (mP);
  \draw[clarrow] (mP) -- (mM);
\end{tikzpicture}%
...
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
Mesma base de \textcite{ipcc2006}.\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
...
\item
  \textbf{Escopo do resultado:} as emissões são operacionais TTW de CO\textsubscript{2}e
...
\parencite{competitiveness2024,modalshiftreview2020}.
